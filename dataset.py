...
class BilingualDataset(Dataset):
    def __init__(self, ds, tokenizer_src, tokenizer_tgt, src_lang, target_lang, seq_len) -> None:
        super().__init__()
    ...
    def __getitem__(self, index: Any) -> Any:
        ...
        # Truncate if too long (safety check, should be handled by filter in train.py)
